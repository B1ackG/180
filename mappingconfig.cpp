...
void MappingConfig::initDefaultMappings()
{
    ...
    m_controlNameMap["TBtn_EOAT_Release"] = "末端释放";
        ...
        m_controlNameMap["techBtn_AGV_Park"] = "支腿";
        m_controlNameMap["techBtn_AGV_驻车"] = "AGV 支腿按钮";
        m_controlNameMap["legControlConfirmBtn"] = "支腿 · 自定义伸出确定";
        m_controlNameMap["legControlRetractBtn"] = "支腿 · 一键收回";
        m_controlNameMap["legControlGear1Btn"] = "支腿 · 展出档位1";
        m_controlNameMap["legControlGear2Btn"] = "支腿 · 展出档位2";
        m_controlNameMap["legControlGearFullBtn"] = "支腿 · 展出全开";
        ...
        m_controlNameMap["techBtn_AGVStep_Rotate"] = "底盘步进 · 原地正转";
